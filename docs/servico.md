...
- **um `scaler` que também detecte entrada fora da faixa vista no treino** — hoje um `creditAmount` de R$ 500.000 sai de `[0, 1]` de propósito (é o certo para o laboratório) e é pontuado sem nenhum aviso de que a rede nunca viu nada parecido.
