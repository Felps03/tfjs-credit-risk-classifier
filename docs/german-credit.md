...
[⬅️ README](../README.md) · [Dados](dados-sinteticos.md) · **German Credit** · [Modelo](modelo.md) · [Métricas](metricas.md) · [Validação cruzada](validacao-cruzada.md) · [Mitigação](mitigacao.md) · [Inferência](inferencia.md) · [API](api.md) · [Testes](testes.md)
